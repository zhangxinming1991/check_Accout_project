...
public class PayRecord implements java.io.Serializable {
	...
	public PayRecord(int id, String payer, double payMoney, String payWay) {
		this.id = id;
		this.payer = payer;
	...
	public PayRecord(int id, String payer, double payMoney, String payWay, String payAccount, String vicePayer,
