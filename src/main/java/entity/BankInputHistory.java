...
/**
 * BankInputHistory generated by hbm2java
 */
public class BankInputHistory implements java.io.Serializable {
	...
	public BankInputHistory() {
	}

	public BankInputHistory(int id) {
		this.id = id;
	}

	public BankInputHistory(int id, String payer, Double money, String payWay, String payerAccount, Integer payid,
			...
			String actualPayer, String paymentNature, String cuscompanyid, String caid) {
		this.id = id;
		this.payer = payer;
		this.money = money;
		this.payWay = payWay;
