...
public class AllPayrecord implements java.io.Serializable {
	...
	public AllPayrecord(int id, String payer, double payMoney, String payWay) {
		this.id = id;
		this.payer = payer;
	...
	public AllPayrecord(int id, String payer, double payMoney, String payWay, String payAccount, String vicePayer,
