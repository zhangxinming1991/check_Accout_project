...
public class BankInputBackup implements java.io.Serializable {
	...
	public BankInputBackup(int id, String payer, Double money, String payWay, String payerAccount, Integer payid,
			String contractNum, Boolean status, String inputTime, String payee, String payeeAccount, String caid,
			Boolean isConnect, String manyContract, Integer connectNum, String connectClient, String owner, Integer num,
