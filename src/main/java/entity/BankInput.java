...
/**
 * BankInput generated by hbm2java
 */
public class BankInput implements java.io.Serializable {
	...
	public BankInput(int id) {
		this.id = id;
	}

	public BankInput(int id, String payer, Double money, String payWay, String payerAccount, Integer payid,
			String contractNum, Boolean status, String inputTime, String payee, String caid, String payeeAccount,
			Boolean isConnect, String manyContract, Integer connectNum, String connectClient, String owner,
			String actualPayer, String paymentNature, Integer num, String cuscompanyid) {
		this.id = id;
		this.payer = payer;
		this.money = money;
		this.payWay = payWay;
