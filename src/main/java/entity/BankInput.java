...
public class BankInput implements java.io.Serializable {
	...
	public BankInput(String payer, Double money, String payWay, String payerAccount, Integer payid, String contractNum,
			Boolean status, String inputTime, String payee, String payeeAccount, Boolean isConnect, String manyContract,
			Integer connectNum, String connectClient, String owner) {
		this.payer = payer;
		this.money = money;
		this.payWay = payWay;
