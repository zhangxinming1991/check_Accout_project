...
public class PayRecordCache implements java.io.Serializable {
	...
	public PayRecordCache(int id, String payer, double payMoney, String payWay) {
		this.id = id;
		this.payer = payer;
	...
	public PayRecordCache(int id, String payer, double payMoney, String payWay, String payAccount, String vicePayer,
