...
public class OriOrderBackup implements java.io.Serializable {
	...
	public OriOrderBackup(OriOrderBackupId id, String orderNum, int num) {
		this.id = id;
		this.orderNum = orderNum;
		this.num = num;
	}

	public OriOrderBackup(OriOrderBackupId id, String orderNum, Double input, Double debt, Double total, String state,
	...
	public OriOrderBackupId getId() {
		return this.id;
	}

	public void setId(OriOrderBackupId id) {
		this.id = id;
	}
