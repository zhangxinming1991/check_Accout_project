...
(function ($) {
        ...
        $(document.body).append(
            $([
                ...
                bottom = $('<div id="pbBottom" />').append([
                    ...
                    $('<div id="pbNav" />').append([
                        leftBtn = $('<a id="pbLeftBtn" href="#" title="向左旋转" />').click(rotateLeft)[0],
                        // prevBtn = $('<a id="pbPrevBtn" href="#" />').click(previous)[0],
                        zoomBtn = $('<a id="pbZoomBtn" href="#" title="缩放" />').click(doubleClick)[0],
                        rightBtn = $('<a id="pbRightBtn" href="#" title="向右旋转" />').click(rotateRight)[0],
    ...
    function resizeImage(to, noAnim) {
        ...
        // round these as some browsers don't like very small css values
            ...
            dur = noAnim ? 0 : options.resizeDuration, fn = (0 == to) ? function () {
                $(image).hide()
            } : function () {
            };
        $(image).animate({width: width, height: height, top: top, left: left}, {
            queue: false,
            duration: dur,
